...
///   }
/// }
pub type EventFn <B: Basics, Steward: for<'a> TimeStewardLifetimedMethods <'a, B>> = for <'a> Fn (&mut <Steward as TimeStewardLifetimedMethods <'a, B>>::Mutator);
pub type PredictorFn<B: Basics, Steward: for<'a> TimeStewardLifetimedMethods <'a, B>> = for <'a> Fn (&mut <Steward as TimeStewardLifetimedMethods <'a, B>>::PredictorAccessor);
