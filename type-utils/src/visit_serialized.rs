...
impl<T: VisitTarget + ?Sized> MaybeVisitTarget for T {
  fn verify(&self) {
    ...
    assert_eq!(
      count, 1,
      "a type implemented VisitTarget without handling the serialization correctly"
    );
  }
}

trait MaybeVisitingSerializerHack: Serializer {
  fn maybe_apply_visitor<T: VisitTarget + ?Sized>(
    &mut self,
    value: &T,
...
impl<S: Serializer> MaybeVisitingSerializerHack for S {
  default fn maybe_apply_visitor<T: VisitTarget + ?Sized>(
    &mut self,
    _value: &T,
  ) -> Option<Result<Self::Ok, Self::Error>> {
    None
...
pub fn maybe_apply_visitor<S: Serializer, T: VisitTarget + ?Sized>(
  serializer: &mut S,
  value: &T,
...
macro_rules! maybe_apply_visitor {
  ($value: expr, $serializer: expr) => {
    if let Some(a) = maybe_apply_visitor(&mut $serializer, $value) {
      return a;
    }
  };
}
...
impl<'a, V: ?Sized> ser::Serializer for VisitingSerializerHack<'a, V> {
  ...
  fn serialize_bool(self, _: bool) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_i8(self, _: i8) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_i16(self, _: i16) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_i32(self, _: i32) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_i64(self, _: i64) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_u8(self, _: u8) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_u16(self, _: u16) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_u32(self, _: u32) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_u64(self, _: u64) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_f32(self, _: f32) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_f64(self, _: f64) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_char(self, _: char) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_str(self, _: &str) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_bytes(self, _: &[u8]) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_none(self) -> Result<(), NeverError> {
    Ok(())
  }
  ...
  fn serialize_unit(self) -> Result<(), NeverError> {
    Ok(())
  }
  fn serialize_unit_struct(self, _name: &'static str) -> Result<(), NeverError> {
    Ok(())
  }
  ...
  fn serialize_seq(self, _len: Option<usize>) -> Result<Self::SerializeSeq, NeverError> {
    Ok(self)
  }
  fn serialize_tuple(self, _len: usize) -> Result<Self::SerializeTuple, NeverError> {
    Ok(self)
  }
  fn serialize_tuple_struct(
    ...
    _name: &'static str,
    _len: usize,
  ) -> Result<Self::SerializeTupleStruct, NeverError> {
    Ok(self)
  }
  fn serialize_tuple_variant(
    ...
    _variant: &'static str,
    _len: usize,
  ) -> Result<Self::SerializeTupleVariant, NeverError> {
    Ok(self)
  }
  fn serialize_map(self, _len: Option<usize>) -> Result<Self::SerializeMap, NeverError> {
    Ok(self)
  }
  fn serialize_struct(
    self,
    _name: &'static str,
    _len: usize,
  ) -> Result<Self::SerializeStruct, NeverError> {
    Ok(self)
  }
  fn serialize_struct_variant(
    ...
    _variant: &'static str,
    _len: usize,
  ) -> Result<Self::SerializeStructVariant, NeverError> {
    Ok(self)
  }
}
...
mod tests {
  ...
  fn test_visit_serialized() {
    ...
    visit_all(
      ...
      &(
        ...
        1i64,
        2i32,
        vec![ToVisit(3), ToVisit(4)],
        vec![Some(ToVisit(5)), None, Some(ToVisit(6))],
        Some(ToVisit(7)),
        &&&&mut &&ToVisit(8),
        Box::new(ToVisit(9)),
        Wrapper(ToVisit(10)),
        WrapperThatIsAlsoUnusedTarget(ToVisit(11)),
        WrapperThatIsAlsoUsedTarget(ToVisit(12)),
      ),
    );
  ...
  #[test]
  #[should_panic(
    expected = "a type implemented VisitTarget without handling the serialization correctly"
  )]
